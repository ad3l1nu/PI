...
<html lang="en">
	...
	<head>
		<title>MediCare Hub : Editează Profilul</title>
						...
						<div class="col-lg-12 col-md-12">
							<div class="service-area">
								...
								<div class="section-heading">
									<h2>Actualizează Fotografia de Profil</h2>
									<div class="line"></div>
								</div>
												...
												<div class="row">
													...
													<div class="col-lg-8 col-md-8 col-sm-6">
														<button class="wpcf7-submit button--itzel" name="dpok" type="submit">
															<i class="button__icon fa fa-share"></i><span>Încarcă</span>
														</button>
													</div>
												</div>
											</form>
										...
										<form class="appointment-form" method="post">
											<?php if ($_SESSION['user_type'] == "client") { ?>
												...
												<div class="row">
													<div class="col-lg-2 col-md-2"></div>
													<div class="col-lg-8 col-md-8 col-sm-6">
														<label class="control-label">Adresă <span class="required">*</span>
														</label>
												...
												<div class="row">
													<div class="col-lg-2 col-md-2"></div>
													<div class="col-lg-8 col-md-8 col-sm-6">
														<label class="control-label">Telefon <span class="required">*</span>
														</label>
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<button class="wpcf7-submit button--itzel" name="update" type="submit">
														<i class="button__icon fa fa-share"></i><span>Actualizează </span>
													</button>
												</div>
												<div class="col-lg-2 col-md-2"></div>
											</div>
									...
									<div class="col-lg-12 col-md-12">
										<form class="appointment-form" method="post">
											<div class="row">
												<div class="col-lg-2 col-md-2"></div>
												<div class="col-lg-8 col-md-8 col-sm-6">
													<label class="control-label">Parola <span class="required">*</span></label>
											...
											<div class="row">
												<div class="col-lg-2 col-md-2"></div>
												<div class="col-lg-8 col-md-8 col-sm-6">
													<label class="control-label">Reintrodu parola <span class="required">*</span></label>
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-8 col-sm-6">
													<button class="wpcf7-submit button--itzel" name="update_pass" type="submit">
														<i class="button__icon fa fa-share"></i><span>Actualizează parola</span>
													</button>
												</div>
											</div>
										</form>
