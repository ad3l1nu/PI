...
<html lang="en">
	...
	<head>
		<title>MediCare Hub : Programări</title>
												...
												<tbody>
													...
													while ($row = mysqli_fetch_array($sql)) {
														...
														<tr>
															...
															<td><a href="<?= $row['report'] ?>" target="_blank">Descărcare</a>
															</td>
															<td><a href="deleteapp.php?data=test&action=delete&id=<?= $row['id']; ?>">Ștergere
																	Programare</a></td>
														</tr>
														<?php
													}
												...
												<tbody>
													...
													while ($row = mysqli_fetch_array($sql)) {
														...
														<tr>
															...
															if ($sts == "Rejected") {
																?>
																<td>Respins de către medic</td>
																<td>
																	<a href="deleteapp.php?data=doctor&action=delete&id=<?= $row['id']; ?>">Ștergere
                                                                        Programare</a>
																</td>
																<?php
															} else {
													...
													<tbody>
														...
														while ($row = mysqli_fetch_array($sql)) {
															...
															<tr>
																...
																<td><a href="deleteapp.php?data=doctor&action=reject&id=<?= $row['id']; ?>">Refuz</a>
																</td>
															</tr>
														<?php
														}
